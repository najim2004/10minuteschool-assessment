          ...
          <div className="flex-1 hidden w-full pr-4 md:block">
            <div className="w-full">
              <div className="relative flex w-full flex-col items-center bg-white z-50">
                <div className="shadow-0 rounded-b-[23px] flex w-full items-center gap-2 rounded-t-[23px] border-0 px-[12px] py-2 md:border border-b">
                  <SearchIcon />
                  <input
                    type="search"
                    autoComplete="off"
          ...
          <div className="flex items-center space-x-4 md:space-x-6">
            ...
            <div className="block">
              ...
              >
                <span
                  id="login-button"
                  className="whitespace-nowrap text-[12px] font-semibold leading-[24px] md:text-[16px] md:font-medium"
                >
                  লগ-ইন
                </span>
              </a>
