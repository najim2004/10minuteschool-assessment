...
function CourseInfo() {
  return (
    ...
    >
      <div className="mx-auto max-w-[1200px] relative flex flex-col gap-4 md:flex-row md:gap-12 pb-6 md:py-10 min-h-[300px]">
        ...
        <section className="w-full md:max-w-[330px] lg:max-w-[400px] order-2 bg-white right-0 md:top-[50px] md:absolute">
